...
const FAQs = () => {
  ...
  const faqsData = [
    // ── Products ──
    {
      ...
      answer:
        "We stock a wide range of natural wellness products including Weight Management Products, Yoni & Female Fertility Care, Men's Boosters & Fertility Support, Natural Skin Care, Nutritional Supplements, Organic Herbs, and Pure Honey & Honey Products. All products are carefully sourced to support your health and wellness journey.",
    },
    {
      category: "Our Products",
      question: "Are your products natural and safe to use?",
      answer:
        "Yes. We prioritize natural, plant-based, and organic formulations across our product range. Each product is sourced from trusted suppliers and is intended for use as directed. If you have a medical condition, are pregnant, or are on medication, we recommend consulting your doctor before use.",
    },
    {
      category: "Our Products",
      question: "Do your products have any side effects?",
      answer:
        "Most of our products are made from natural ingredients and are generally well tolerated. However, individual reactions can vary. We recommend reading the product description and ingredients carefully before purchase. If you experience any adverse reaction, discontinue use and consult a healthcare professional.",
    },
    {
      category: "Our Products",
      question: "Are your honey products pure and unprocessed?",
      answer:
        "Yes. Our Pure Honey & Honey Products are sourced to retain their natural flavor, golden color, and essential nutrients. We do not stock honey that has been heavily processed or adulterated with additives.",
    },
    {
      category: "Our Products",
      question: "What organic herbs do you carry?",
      answer:
        "Our Organic Herbs range includes pure, sustainably sourced herbs used for general wellness, detox, and traditional wellness rituals. Product availability changes regularly — check our shop for the latest selection.",
    },
    ...
    // ── Orders & Delivery ──
    {
      ...
      answer:
        "You can browse and purchase directly from our online shop at organicbloom.co.ke. Simply add your items to cart, proceed to checkout, and complete your payment. You'll receive a confirmation once your order is placed.",
    },
    {
      category: "Orders & Delivery",
      question: "Do you deliver across Kenya?",
      answer:
        "Yes, we deliver nationwide across Kenya. Delivery timelines and fees may vary depending on your location. Nairobi orders are typically fulfilled faster. You'll see delivery details at checkout.",
    },
    {
      category: "Orders & Delivery",
      question: "How long does delivery take?",
      answer:
        "Nairobi orders are usually delivered within 1–3 business days. Deliveries to other counties may take 3–7 business days depending on your location and courier availability.",
    },
    {
      category: "Orders & Delivery",
      question: "How will I know my order has been dispatched?",
      answer:
        "Once your order is dispatched, you will receive a notification via SMS or email with tracking details. You can also reach out to us directly on our contact channels for an update.",
    },
    ...
    // ── Payments ──
    {
      ...
      answer:
        "We accept M-Pesa, bank transfers, and card payments. Payment options available to you will be displayed at checkout.",
    },
    {
      category: "Payments",
      question: "How can I apply store credit or funds to my order?",
      answer:
        "If you have available store credit or funds in your account, you'll see an option to apply them at checkout before finalising your payment.",
    },
    {
      category: "Payments",
      question: "How do I check if a refund has been credited to my account?",
      answer:
        "You can log into your account and navigate to the 'My Funds' or 'Account Balance' section to view your transaction history and any credited refunds.",
    },
    ...
    // ── Wholesale ──
    {
      ...
      answer:
        "Yes, we offer wholesale pricing for businesses, spas, clinics, and bulk buyers. Please contact our sales team directly to discuss your needs and set up a wholesale account.",
    },
    ...
    // ── General ──
    {
      ...
      answer:
        "You can reach us via our website contact form, WhatsApp, or email. Our team is happy to help with product recommendations, order queries, or any other questions you may have.",
    },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[500px] md:h-[600px] overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={organicImage}
            alt="Organic Bloom natural wellness products"
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-primary/40 via-secondary/30 to-primary/20" />
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-20 left-20 w-32 h-32 rounded-full bg-primary/30 blur-3xl" />
            <div className="absolute bottom-20 right-20 w-40 h-40 rounded-full bg-secondary/40 blur-3xl" />
          </div>
        </div>
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground">
                Find answers to common questions about our natural wellness products and services
              </p>
            </div>
                ...
                <div key={category}>
                  ...
                  <div className="space-y-4">
                    {faqsData
                      ...
                      .map((faq) => {
                        const globalIndex = faqsData.indexOf(faq);
                        return (
                          <div
                            key={globalIndex}
                            className="bg-card border border-border rounded-xl overflow-hidden hover:shadow-md transition-shadow duration-300"
