...
const UserProfile = () => {
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      try {
        setIsLoading(true);
        const response = await fetch('https://bloom-backend-zzcv.onrender.com/api/v1/auth/me', {
          method: 'GET',
          headers: {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        ...
        const response = await fetch('https://bloom-backend-zzcv.onrender.com/api/v1/orders?status=&page=1&limit=10', {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json',
  ...
  const handleCancelOrder = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `https://bloom-backend-zzcv.onrender.com/api/v1/orders/${selectedOrderId}/cancel`,
        {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`,
